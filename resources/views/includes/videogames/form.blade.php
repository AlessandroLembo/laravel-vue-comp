    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control bg-dark text-light" id="title" name="title" value="{{ old('title', $videogame->title) }}" required minlength="5" maxlength="50">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="file" class="form-control bg-dark text-light" id="image" name="image" value="{{ old('image', $videogame->image) }}">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="number" class="form-control bg-dark text-light" id="price" name="price" value="{{ old('price' , $videogame->price) }}">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="date" class="form-control bg-dark text-light" id="sale_date" name="sale_date" value="{{ old('sale_date' , $videogame->sale_date) }}">
